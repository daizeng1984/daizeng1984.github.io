...
# Preword
To understand blend func or op in graphics API, the best place to go is this [website](https://www.andersriggelsen.dk/glblendfunc.php). Even though it's OpenGL but it should be same in DX.
