...
* Copy vs Clone: Copy happens at assignment or ownership transfer, all primitive type implements this; Clone is clone trait. You can use compiler to generate bit by bit copy/clone #[derive(Debug,Clone,Copy)] shallowly.
