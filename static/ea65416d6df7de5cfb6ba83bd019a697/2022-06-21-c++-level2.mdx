...
# Thread
You should use lock free or non-blocking concurrency. That means better stay away from mutex, semaphore etc. But use atomic and spinlock. Careful design your datastructure. For competing resource, spin lock it; For 
