...
# Rust In Action (MEAP) (⭐⭐⭐⭐) [Rust Cook Book](https://rust-lang-nursery.github.io/rust-cookbook/intro.html)
...
* str -> c style stack/static ; String -> std::string heap and guess primitive follow the same pattern vs Box.
