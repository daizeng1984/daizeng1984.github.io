...
# Direnv
Nix ❤ Direnv. These two are so powerful. Direnv grants you seamless environment while Nix guarantees they are reliable and reproducible. My rest blogs are merely snippets of these two. Direnv can [work with conda]() too!
