...
* all primitives on stack follow the similar pattern because they implement Copy trait. When you do assignment Rust will never automatically create “deep” copies. Rust choose to transfer ownership and invalidate the previous owner unless you impl Copy.
