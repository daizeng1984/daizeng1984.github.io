...
* Copy trait is not implement unless primitive type. Assigning value leads ownership transfer. Not convenient but this avoid c++ copy/move constructor assumption issue.
