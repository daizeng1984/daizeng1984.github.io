...
## Push/Pop States
API leaves for you to manage all states, my dear. Let's finish it with one blow by enumerating all states possible. Cause you never know which state is giving you black screen 🤦. It's rocket launcher solution: no time for these little hide & see games, just nuclear it 😆!
```cpp
