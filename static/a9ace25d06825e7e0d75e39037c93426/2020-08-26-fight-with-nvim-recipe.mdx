...
```
The ticket is sticked to whether we should include bash in conda while conda is relies on bash. I don't have much time recently and fell into new love to zoxide, which is much faster and [Nix]().
