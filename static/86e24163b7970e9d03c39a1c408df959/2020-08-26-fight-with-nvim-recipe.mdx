...
```
The ticket is sticked to whether we should include bash in conda while conda is relies on bash. I realized don't have much time then and drop the conversation and later fell into new love zoxide, which is much faster and also kinds of migrating my pkg army to [Nix](./2020-10-24-nix-power) which is more rooty and powerful.
