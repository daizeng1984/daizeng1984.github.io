...
To build a reproducible env is the Nix's Ultimate Power. You can live without NixOS or not using Home-Manager. But this one, you cannot miss it!

# Direnv
Nix ❤ Direnv. These two are so powerful. Direnv grants you seamless environment while Nix guarantees they are reliable and reproducible. My rest blogs are merely snippets to showcase/advertise. Direnv can [work with conda]() too!
...
# Rust
Hottest language I'm planning to learn.
