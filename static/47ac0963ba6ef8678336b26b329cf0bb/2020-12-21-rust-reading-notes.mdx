...
* like c++ "hell,world" static, str -> c style string in stack ; String -> c++ std::string in heap and I *guess* primitive follow the same pattern vs Box. When you do assignment Rust will never automatically create “deep” copies. Rust choose to transfer ownership and invalidate the previous owner.
* Box:new, * unary and drop -> C++ new/delete
