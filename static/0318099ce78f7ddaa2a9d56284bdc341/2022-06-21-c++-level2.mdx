...
# Thread
You should use lock free or non-blocking concurrency. That means better stay away from mutex, semaphore etc. But use atomic and spinlock. Careful design your datastructure. For competing resource e.g. multiple writers, spin lock it; For 
