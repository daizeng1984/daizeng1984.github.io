...
## Gedit
You can get any version in git like god using `:Gedit object`. For example, if I want to see the file in a feature branch, I just do `:Gedit branchname:/path/to/file`. Or if not sure about the filename, I'll just `:Gedit branchname:` to open files.
