...
* fixed len: [i32;3] vs slices: &[usize] vs vec: Vec<i32\>
* for x in v.iter() or &v
* common methods: push/pop, append/split_off, dedup, clear, reserve/with_capacity, insert/remove, resize, splice, as_((mut_)slice/ptr)

### String
* String vs str and Rust also has the real things: CString vs CStr
* String::from("...") vs "...".to_string
* Since the interexchange of 2 types usually happens, it's wise to make function arguments as slices: &str
* common methods for both String/str: push/pop, push_str
