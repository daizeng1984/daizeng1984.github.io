...
## Python
Simply run `pip install python-language-server` figure out your `pyls` binary path and you are done!

## Javascript
Same as Python, you just need to `npm install javascript-typescript-langserver` and find the binaries.
