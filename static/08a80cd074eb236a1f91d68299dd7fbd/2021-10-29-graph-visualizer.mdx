...
# Simple
I used to make [fancy graph](https://drive.google.com/file/d/12ku-mqtJtsGfC8rbUQUMC2GTXgjWDHhl/view?usp=sharing) for visualization apps. But sometimes I just want something simple, online browser accessible and can help me quickly visualize some json DAG or flow chart. Got this nice workflow visualizer from Google and happy to use it as a tool.
