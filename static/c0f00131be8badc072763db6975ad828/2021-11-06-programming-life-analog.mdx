...
To use it well, you need to just treat any callback as stateless handler. Machine with no soul... Do any job at any time by taking the resources ready and return you the results.
