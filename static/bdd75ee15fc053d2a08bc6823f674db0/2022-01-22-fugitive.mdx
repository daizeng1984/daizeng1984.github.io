...
Most powerful git tool vim ever created...
...
Theirs: ......//3/demo.js
```
Then you 3-way merge will refer to these buffer with the name `2`, `demo` and `3`. For example, to get from `Ours`, we type `:diffget 2`.
