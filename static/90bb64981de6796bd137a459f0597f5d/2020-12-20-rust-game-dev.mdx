...
## Amethyst
[Amethyst](https://www.amethyst.rs/) seems to be almost ripe so let's try that out. It uses entity components system to model multithread behavior I guess similar to actor framework etc. by Erlang. These model ensured some correct distributed safe behavior to avoid dead lock etc.. 
