...
* cache friendly programming tricks: abusing hardware. this is like dark alchemy: https://stackoverflow.com/questions/16699247/what-is-a-cache-friendly-code Note you need to know your hardware and compiler well and only use it for bottleneck's bottleneck. It's often not transferrable when moving to different devices.
