...
8. To debug the wasm, you need to add `-g` flag and use google-chrome browser with DWARF plugin (see [here](https://developer.chrome.com/blog/wasm-debugging-2020/)). It's just this feature still beta version, might be unstable.
