...
# Why?
I know you should have a framework anyway. But what if not or you need to do some low level API hack? You probably need to anyway find a toy example to get started.
