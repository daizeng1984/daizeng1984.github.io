...
# Preword
Skybox and cubemap etc. can be expensive. Here's one of my tricks to use just one single texture to achieve similar mapping.
...
![Sphere Map](../images/blog/2009/mapping-sphere-cylinder.jpg)
