...
## \*\*O
VBO, VAO, EBO, FBO API is unhuman. But here a simple explanation: VBO is just buffer to store vertex, FBO is buffer to store pixels, while VAO is wrapper to manage VBO.
...
glm::mat4 View = glm::lookAt(
    glm::vec3(${1:0,0,0}), // Camera is at (4,3,3), in World Space
    glm::vec3(${2:0,0,-1}), // and looks at the origin
