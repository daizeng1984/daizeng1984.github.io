...
# Next
Next I want it to be flexible for all json format: I can visciously `eval` a Javascript snippet for converting any json into the format.

TODO:
- [] Add eval to input and add debounce for changes
