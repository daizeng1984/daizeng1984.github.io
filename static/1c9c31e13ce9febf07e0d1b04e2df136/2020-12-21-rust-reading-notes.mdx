...
# Rust In Action (MEAP) (⭐⭐⭐⭐) + [Nightly Official Guide](https://doc.rust-lang.org/nightly/book/index.html) (⭐⭐⭐⭐) + [Rust Cook Book](https://rust-lang-nursery.github.io/rust-cookbook/intro.html)
