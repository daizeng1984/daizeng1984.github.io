...
## Git diff(tool)
You can directly diff two version e.g. `G diff sha1 sha2`. It returns you the diff objects like `diff --git a/... b/...` where you can directly press `Enter` to view diff.
