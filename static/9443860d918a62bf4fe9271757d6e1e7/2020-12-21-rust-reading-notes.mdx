...
After my reading, I believe knowing rust can help foster lots of good C++ habits that C++ junior won't be told when first diving to C++ project. Learning rust could be the fastest way to know how to be a better C++ coder.
