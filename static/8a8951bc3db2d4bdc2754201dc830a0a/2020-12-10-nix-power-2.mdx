...
Nixpkgs already has emscriptenPackages ready but if you can compile your own as shown [here](https://github.com/NixOS/nixpkgs/blob/master/doc/languages-frameworks/emscripten.section.md#user-content-usage-2-pkgsbuildemscriptenpackage).
