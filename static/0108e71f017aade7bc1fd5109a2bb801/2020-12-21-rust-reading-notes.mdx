...
## Flow
* if condition must be bool. Because a lot of implicit bool in other lang brings a lot of monsters. let x = if con {1} else {2}; is valid as long as type is the same
