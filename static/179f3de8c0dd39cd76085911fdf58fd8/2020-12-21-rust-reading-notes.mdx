...
# Type
Conversion is explicit through `as` and each type has its method like *24.5_f32*.`round()` is method to round *24.5_f32* to *25*. Format type "{:b}{:o}{:x}". float comparison is tolerate with e.g. `f32::EPSILON`.
