...
Then it grab the register/clipboard and return the correct google drive link as markdown image. But it's essentially just vim command. Feel free to convert the line after `!v` as your vim command.
