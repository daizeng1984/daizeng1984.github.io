...
## Git diff(tool)
You can directly diff two version e.g. `G diff sha1 sha2`. It returns you the list of diff in quickfix window where you can directly press `Enter` to view diff.
