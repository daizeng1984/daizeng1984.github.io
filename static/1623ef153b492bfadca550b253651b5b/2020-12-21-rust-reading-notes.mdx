...
* common methods: len, is_empty, push/pop, append/split_off, dedup, clear, reserve/with_capacity, insert/remove, resize, splice, as_((mut_)slice/ptr), get/[]
