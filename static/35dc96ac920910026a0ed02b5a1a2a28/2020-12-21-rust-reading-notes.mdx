...
* homework or why not using Rust for code interview: try to implement link list using Rust (ref https://rust-unofficial.github.io/too-many-lists/second-option.html)
