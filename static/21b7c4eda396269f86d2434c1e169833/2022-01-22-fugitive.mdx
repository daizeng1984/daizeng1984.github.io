...
In following, I'll just call them object with this context. Plus normal git syntax, it's easy enough to identify files of different branch and commits. Let's see how powerful it is.
