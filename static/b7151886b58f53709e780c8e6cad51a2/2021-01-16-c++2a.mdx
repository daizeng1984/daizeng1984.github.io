...
* print all elems in container: copy(v.begin(), v.end(), ostream_iterator<std::string>(std::cout, ","));

## String
* stringstream << ... <<
* istringstream("...") std::istream_iterator<T\>(istringstream)
* ostringstream std::ostream_iterator<T>(ostringstream, delim)
