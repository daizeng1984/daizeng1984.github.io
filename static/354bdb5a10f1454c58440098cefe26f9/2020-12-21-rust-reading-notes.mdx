...
## Ownership
Unique features to enforce memory allocation awareness and foster good habits. Rust want as powerful as c/c++ to take advantage of different memory models!
