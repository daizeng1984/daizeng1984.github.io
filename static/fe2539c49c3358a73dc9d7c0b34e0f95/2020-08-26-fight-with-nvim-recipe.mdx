...
```
The ticket is sticked to whether we should include bash in conda while conda is relies on bash. I don't have much time at that time and drop a bit and later fell into new love to zoxide, which is faster and [Nix](./2020-10-24-nix-power).
