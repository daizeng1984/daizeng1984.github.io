...
* cache friendly programming tricks: abuse hardware. this is like dark alchemy: https://stackoverflow.com/questions/16699247/what-is-a-cache-friendly-code Note you need to know hw and compiler well and only use it for bottleneck's bottleneck.
