...
# Rust In Action (MEAP) (⭐⭐⭐⭐) + [Nightly Official Guide](https://doc.rust-lang.org/nightly/book/index.html) (⭐⭐⭐⭐)
...
<img style="max-width:50rem;" source="https://benchmarksgame-team.pages.debian.net/benchmarksgame/download/fastest.svg" />
...
* str -> c style stack/static ; String -> std::string heap
