...
* lower_bound search >= given val, upper_bound search > given val when given less default comparator
...
## Containers
* construction {1, 2, 3, ...}; or {{1, 2}, ...}; note constructor({}) == {{}}; destruction auto [x, y, z]; 
...
## String
* tolower for char, for string use transform(begin, end, tolower)
* stringstream << ... <<
