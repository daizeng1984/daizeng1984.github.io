...
For example, my neovim plugin [Snip-n-Paste](https://github.com/daizeng1984/vim-snip-and-paste), requires [pygobject](https://pygobject.readthedocs.io/en/latest/getting_started.html) which usually took quite some time to get it right, but now it's simply: `conda install -c pkgw-forge -c conda-forge gtk3 pygobject`. Another example is installing the servers for LanguageClient e.g. cquery.
