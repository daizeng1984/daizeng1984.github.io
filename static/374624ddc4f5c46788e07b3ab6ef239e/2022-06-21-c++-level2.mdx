...
# Background 1
So this article just lists what I believe should have for senior C++ programmers. Most of them are probably biased to game dev and are inspired a lot from either Boost, Folly, EASTL etc. Even though learning to game dev, but I think most of cure for problem are commonly shared across similar problems in different field.
